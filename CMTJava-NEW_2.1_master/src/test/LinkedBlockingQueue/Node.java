...
class Node<E> implements TObject{
	...
	private Conteiner<E> item = new Conteiner<E> ();
private FieldInfo<E> itemFieldInfo = new FieldInfo<E> ("item", (E a) -> {item.setConteudo(a); return null;});
...
private FieldInfo<Node<E>> nextFieldInfo = new FieldInfo<Node<E>> ("next", (Node<E> a) -> {next.setConteudo(a); return null;});
	...
	public STM<Node<E>> getNext() {
	 ...
	 Node(E x) 
	{
				this.item.setConteudo(x);
				this.next.setConteudo(null);
		}
