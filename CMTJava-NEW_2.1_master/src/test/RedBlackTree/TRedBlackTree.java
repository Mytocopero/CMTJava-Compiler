...
public class TRedBlackTree implements TObject{
	...
	private FieldInfo<TreeNode> rootFieldInfo = new FieldInfo<TreeNode> ("root", (TreeNode a) -> {root = a; return null;});
    ...
    private static TreeNode EMPTY;
	private FieldInfo<TreeNode> EMPTYFieldInfo = new FieldInfo<TreeNode> ("EMPTY", (TreeNode a) -> {EMPTY = a; return null;});
