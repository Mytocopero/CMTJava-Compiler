...
private FieldInfo<Node<E>> headFieldInfo = new FieldInfo<Node<E>> ("head", (Node<E> a) -> {head.setConteudo(a); return null;});
	...
	private Conteiner<Node<E>> tail = new Conteiner<Node<E>> ();
private FieldInfo<Node<E>> tailFieldInfo = new FieldInfo<Node<E>> ("tail", (Node<E> a) -> {tail.setConteudo(a); return null;});
	...
	public STM<Node<E>> getTail() {
  	...
  	private Conteiner<Integer> size = new Conteiner<Integer> ();
private FieldInfo<Integer> sizeFieldInfo = new FieldInfo<Integer> ("size", (Integer a) -> {size.setConteudo(a); return null;});
	...
	public STM<Integer> getSize() {
	 ...
	 TLinkedList() 
	{
				this.head.setConteudo(null);
				this.tail.setConteudo(null);
	    		this.size.setConteudo(0);
		}
