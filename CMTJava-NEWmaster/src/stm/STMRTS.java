...
public class STMRTS {
	...
	*/
	...
	public static <A, B> STM<B> bind(STM<A> t, Function< A, STM<B>> f) {

		return new STM<B>((Trans a) -> {

		    TResult<A> r1 = t.stm.apply(a);
		    TResult<B> r2;

		    if (r1.state == Trans.Status.ACTIVE) {
		        STM<B> r3 = f.apply(r1.result);
		        r2 = r3.stm.apply(r1.newTrans);
	...
	*/
	...
	public static <A, B> STM<B> then(STM<A> a, STM<B> b) {
		...
		return new STM<B>((Trans t1) -> {
		    TResult<A> r1 = a.stm.apply(t1);
		    TResult<B> r2;
		    if (r1.state == Trans.Status.ACTIVE) {
		        r2 = b.stm.apply(r1.newTrans);
		    } else {
		        r2 = new TResult(null, r1.newTrans, r1.state);
		    }
		    return r2;
	...
	*/
	...
	public static STM<Void> retry(){
		...
		return new STM<Void>((Trans t1) -> {
				    TResult r2;
				    r2 = new TResult(new Void(), t1, Trans.Status.RETRY);
				    return r2;
				});
    }
	...
	*/
	...
	public static <A> STM<A> stmReturn(A a) {
		...
		return new STM<A>((Trans t1) -> {
		    TResult<A> r2;
		    r2 = new TResult(a, t1, Trans.Status.ACTIVE);
		    return r2;
		});
    }	
