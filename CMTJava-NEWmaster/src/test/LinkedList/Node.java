...
class Node<E> implements TObject{
	...
	private E element;
	private FieldInfo<E> elementFieldInfo = new FieldInfo<E> ("element", (E a) -> {element = a; return null;});
	...
	private Node<E> next;
	private FieldInfo<Node<E>> nextFieldInfo = new FieldInfo<Node<E>> ("next", (Node<E> a) -> {next = a; return null;});
	...
	private FieldInfo<Node<E>> previousFieldInfo = new FieldInfo<Node<E>> ("previous", (Node<E> a) -> {previous = a; return null;});
