...
public class TLinkedBlockingQueue<E> implements TObject{
	...
	private FieldInfo<Integer> capacityFieldInfo = new FieldInfo<Integer> ("capacity", (Integer a) -> {capacity = a; return null;});
	...
	private FieldInfo<Integer> countFieldInfo = new FieldInfo<Integer> ("count", (Integer a) -> {count = a; return null;});
	...
	private FieldInfo<Node<E>> lastFieldInfo = new FieldInfo<Node<E>> ("last", (Node<E> a) -> {last = a; return null;});
