...
class TLinkedList<E> implements TObject{
	...
	private Node<E> tail;
	private FieldInfo<Node<E>> tailFieldInfo = new FieldInfo<Node<E>> ("tail", {Node<E> a => tail = a; });
	...
	private FieldInfo<Integer> sizeFieldInfo = new FieldInfo<Integer> ("size", {Integer a => size = a; });
