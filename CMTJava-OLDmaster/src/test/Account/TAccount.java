...
class TAccount implements TObject{
	...
	private FieldInfo<Double> balanceFieldInfo = new FieldInfo<Double> ("balance", {Double a => balance = a; });
	...
	private FieldInfo<Integer> opsFieldInfo = new FieldInfo<Integer> ("ops", {Integer a => ops = a; });
